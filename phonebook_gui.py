...
def load_gui(self):
    ...
    # labling the fname, lname, phone, email and user
    # also postiong those labels 
    ...
    # defines the listbox with a scrollbar and positioning them
    ...
    # adding buttons and positioning them 
